...
Hambar_Capre::Hambar_Capre (): nume(NULL), nr(0), mancare (NULL){}

Hambar_Capre::Hambar_Capre (const char *nume, int nr, const char* mancare, double mancare_consumata_zilnic[3])
{
...
double* Hambar_Capre::Get_Cantitate ()
{
    return mancare_consumata_zilnic;
}

int Hambar_Capre::Get_Number ()
{
    return nr;
}

char* Hambar_Capre::Get_Name ()
{
    return nume;
}

Hambar_Capre::~Hambar_Capre ()
{
    delete[]nume;
    delete[]mancare;
}